...
try {
    ...
    $recipients = $formConfig['tequilaloslobos.mx@gmail.com'];
    ...
    if ($formConfig['useSmtp']) {
        ...
        $mail->Host = $formConfig['stmp.gmail.com'];
        ...
        $mail->Username = $formConfig['tequilaloslobos.mx@gmail.com'];

        // Password to use for SMTP authentication
        $mail->Password = $formConfig['Thll23121223?'];
    }
